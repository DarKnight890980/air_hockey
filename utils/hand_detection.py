...
class HandDetection():
    ...
    def create_trackbars(self):
        ...
        cv2.createTrackbar('SatMin', 'Trackbars', 40, 255, empty)
        cv2.createTrackbar('SatMax', 'Trackbars', 136, 255, empty)
...
#     frame = cv2.flip(frame,17)

#     centroids = hd.get_centroid(frame)
